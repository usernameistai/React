...
// @access  Public
router.get('/handle/:handle', (req, res) => { // public route so don't need passport middleware
    const errors = {};    
...
// @access  Public
router.get('/user/:user_id', (req, res) => { // public route so don't need passport middleware
    const errors = {};    
...
router.post(
    ...
    // Get Fields
        ...
        // Skills - Split into array as coming in as CSV
        if(typeof req.body.skills !== 'undefined') {
            profileFields.skills = req.body.skills.split(','); // array of skills not just CSV
        }
        // Social
